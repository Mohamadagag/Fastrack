...
import "../styles/PricacyPolicy.css";
...
const PricacyPolicy = () => {
  return (
    <div className="container privacy-container">
      ...
      <p>
        Fast Track Rent a Car LLC ('us', 'we', or 'our') operates
        http://fastrack.fr/ (the 'Site'). This page informs you of our policies
      ...
      <p>
        This Privacy Policy is effective as of 1st June 2021 and will remain in
